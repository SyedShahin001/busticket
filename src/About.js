...
const About = () => {
  ...
  const handleQuestionClick = (index) => {
    if (selectedQuestion === index) {
      setSelectedQuestion(null); // If already selected, deselect it
    } else {
      setSelectedQuestion(index); // Otherwise, select the clicked question
    }
  };

  return (
    <div className="page-center"> {/* Container div for centering */}
